...
Shader "ASESampleShaders/CustomOutlineToon"
{
	Properties
	{
		...
		_RimValue("RimValue", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float4 color268 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
			float4 lerpResult269 = lerp( float4( lerpResult265 , 0.0 ) , color268 , _BlackValue);
			float4 BaseColor253 = lerpResult269;
			o.Emission = ( BaseColor253 * float4( (_OutlineTint).rgb , 0.0 ) ).rgb;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 lerpResult187 = lerp( temp_cast_4 , indirectSpecular106 , _IndirectSpecularContribution);
			...
			float3 temp_output_158_0 = ( ( ( lerpResult117 * ase_lightColor.a * temp_output_214_0 ) + ( ase_lightColor.rgb * lerpResult159 ) ) * (( tex2DNode76 * _BaseTint )).rgb );
			float grayscale264 = Luminance(temp_output_158_0);
			float3 temp_cast_7 = (grayscale264).xxx;
			float3 lerpResult265 = lerp( temp_output_158_0 , temp_cast_7 , _GrayscaleValue);
			float4 color268 = IsGammaSpace() ? float4(0,0,0,0) : float4(0,0,0,0);
			float4 lerpResult269 = lerp( float4( lerpResult265 , 0.0 ) , color268 , _BlackValue);
			float4 BaseColor253 = lerpResult269;
			float dotResult88 = dot( NewNormals220 , ase_worldViewDir );
			c.rgb = ( float4( ( lerpResult187 * HighlightColor249 * LightColorFalloff227 * pow( temp_output_189_0 , 1.5 ) * saturate( ( ( staticSwitch195 + _HighlightCellOffset ) / ( ( 1.0 - temp_output_189_0 ) * _HighlightCellSharpness ) ) ) ) , 0.0 ) + BaseColor253 + float4( ( ( saturate( NdotL236 ) * pow( ( 1.0 - saturate( ( dotResult88 + _RimOffset ) ) ) , _RimPower ) ) * HighlightColor249 * LightColorFalloff227 * (( _RimColor * ( 1.0 - _RimValue ) )).rgb ) , 0.0 ) ).rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=18707
1920;81;1920;1019;-1891.494;-1341.274;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;59;953.8674,644.3355;Float;False;Property;_BaseCellOffset;Base Cell Offset;3;0;Create;True;0;0;False;0;False;0;-1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;89;2072.556,1825.936;Float;False;Property;_RimOffset;Rim Offset;16;0;Create;True;0;0;False;0;False;0.6;0.718;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;3324.493,1115.83;Inherit;False;Property;_GrayscaleValue;GrayscaleValue;26;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;271;2340.26,2178.135;Inherit;False;Property;_RimValue;RimValue;24;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;270;3845.187,1220.426;Inherit;False;Property;_BlackValue;BlackValue;25;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;268;3867.187,1005.426;Inherit;False;Constant;_Color0;Color 0;21;0;Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;98;2590.947,1945.34;Float;False;Property;_RimColor;Rim Color;14;1;[HDR];Create;True;0;0;False;0;False;1,1,1,0;0.2294117,0.3505882,0.4,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;269;4128.187,910.4258;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;273;2687.494,2159.274;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;92;2577.555,1840.936;Float;False;Property;_RimPower;Rim Power;15;0;Create;True;0;0;False;0;False;0.4;0.01;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;272;2899.26,2009.135;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;253;4428.404,795.8395;Float;False;BaseColor;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;254;4306.977,1596.032;Inherit;False;253;BaseColor;1;0;OBJECT;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;185;4617.75,1638.073;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0.3382353,0.3382353,0.3382353;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;163;4862.104,766.5807;Inherit;True;3;3;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;252;5014.134,532.408;Inherit;True;253;BaseColor;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D69321112458C1AC964904435855C720AA6F8E77